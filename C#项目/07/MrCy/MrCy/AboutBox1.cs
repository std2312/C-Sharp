...
namespace MrCy
{
    partial class AboutBox1 : Form
    {
        ...
        {
            this.Text = "关于";
            this.labelProductName.Text = "餐饮管理系统";
            this.labelVersion.Text = String.Format("版本 {0}", "  10.0.10.0");
            this.labelCopyright.Text = "版本所有开发小组";
            this.labelCompanyName.Text = "吉林省**科技有限公司";
            this.textBoxDescription.Text = "此产品受国家法律公约保护,本公司有终结权";
        }
