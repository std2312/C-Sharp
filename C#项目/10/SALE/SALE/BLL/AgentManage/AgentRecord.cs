...
namespace SALE.BLL.AgentManage
{
    class AgentRecord
    {
        ...
        public DataTable GetDataTable(string strTableName, string strWhere)
        {
            ...
            string strSql = "Select CustomerId,CustomerName,JuridicalPerson,PhoneNumber,ProvinceCode,";
            strSql += "Address,PostalCode,URL,OpenAccBankName,AccountNumber,CertificateNumber,";
            strSql += "IsCancel,CustomerType,Remark,OperatorCode From " + strTableName + " " + strWhere;
            try
            {
        ...
        public bool Insert(DataGridView dgv,BindingSource bs)  //与方法AddDataGridViewRow公用一个dt内存表
        {
            dgv.EndEdit();
            bs.EndEdit();
