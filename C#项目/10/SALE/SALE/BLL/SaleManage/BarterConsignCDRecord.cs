...
namespace SALE.BLL.SaleManage
{
    class BarterConsignCDRecord
    {
        ...
        private string m_BarterConsignCDRecordSql = "Select * From BarterConsignCDRecord ";
        public string BarterConsignCDRecordSql
        {
            get
            {
                return m_BarterConsignCDRecordSql;
            }
        }
    }
}
