...
namespace SALE.DAL
{
    class DataLogic
    {
        ...
        public DataLogic()
        {
            string strServer = OperFile.GetIniFileString("DataBase", "Server", "", Application.StartupPath + "\\SALE.ini");
            //获取登录用户
            string strUserID = OperFile.GetIniFileString("DataBase", "UserID", "", Application.StartupPath + "\\SALE.ini");
            //获取登录密码
            string strPwd = OperFile.GetIniFileString("DataBase", "Pwd", "", Application.StartupPath + "\\SALE.ini");
            //数据库连接字符串
            string strConn = "Server = " + strServer + ";Database=SALE;User id=" + strUserID + ";PWD=" + strPwd;
